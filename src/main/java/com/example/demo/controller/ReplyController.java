...
public class ReplyController {
	...
	public String doDelete(HttpServletRequest req, int id, String replaceUri) {
		...
		ResultData loginedMemberCanDeleteRd = replyService.userCanDelete(rq.getLoginedMemberId(), reply, false);
	...
	public String doModify(HttpServletRequest req, int id, String body) {
		...
		ResultData loginedMemberCanModifyRd = replyService.userCanModify(rq.getLoginedMemberId(), reply, false);
